...
list.append("Alicia")
list.append("Beatriz")
list.append("Carolina")
print(list)

# 4) Reemplazar el segundo y último valor de la lista “animales” con las palabras 
# “loro” y “oso”, respectivamente. Imprimir la lista resultante por pantalla. ¡Puedes 
# hacerlo como se muestra en los videos o bien investigar cómo funciona el indexing 
...
# Elimina el primer valor que encuentra como mayor número en la lista.

# 6) Crear una lista con números del 10 al 30 (incluído), haciendo saltos de 
# 5 en 5 y mostrar por pantalla los dos primeros
list = []
...
# 10) Elaborar una lista anidada llamada “lista_anidada” que contenga los siguientes 
# elementos:
